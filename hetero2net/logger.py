...
def setup_logger(
    ...
    color: bool = True, name: str = "Hetero^2Net", abbrev_name: Optional[str] = None
):
    """Initialize the HeteroGNN logger and set its verbosity level to "DEBUG".
    ...
    name : str, optional
        the root module name of this logger, by default "HeteroGNN"
...
def get_logger(name: str = "HeteroGNN"):
    """Get a logger for a given name.

    Parameters
    ----------
    name : str, optional
        name of the logger, by default "HeteroGNN"
